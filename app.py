...
class PathologyTestsForm(tk.Tk):
    ...
    def setup_flask_routes(self):
        ...
        <div class="container mt-3">
            <div class="hospital-header">
                ...
                <button class="btn btn-success w-100" onclick="generateFillableForm()">📋 Generate Fillable Form</button>
            </div>
        </div>
    ...
    def generate_exact_format_html_form(self, patient_data, selected_tests):
        ...
        # Add submit JS
        html_content += f'''
        <div class="mt-3"><button class="btn btn-success" onclick="submitForm()">✅ Submit & Send WhatsApp Report</button></div>
        </div>
        <script>
        function submitForm(){{
